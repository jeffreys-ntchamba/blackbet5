    ...
    <div className={classes.root}>
      <Card className={classes.card}>
        <Grid container direction="row"  justifyContent={'center'}>
          ...
          <Grid item>
            <Typography variant="h1" color={'#EAB308'}>Bet</Typography>
          </Grid>
        </Grid>
        ...
        <form className={classes.form}>
          ...
          />
          <Typography variant="h5">Contact <span style={{ color: 'red' }}>*</span></Typography>
          <TextField
            fullWidth
            label="Contact"
            variant="outlined"
      ...
      <Typography variant="body2" className={classes.footer}>
        <RouterLink to="/pages/login/login3" style={{ textDecoration: 'none', color: '#EAB308' }}>
        Log in
        </RouterLink>
      </Typography>
